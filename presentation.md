...
This presentation will briefly but comprehensively pitch an [application](https://djolas007.shinyapps.io/Prewordict/) for predicting the next word.
...
* The next word prediction app is hosted on shinyapps.io: [https://djolas007.shinyapps.io/Prewordict](https://nierhoff.shinyapps.io/cdsc)

* The whole code of this application, as well as all the milestone report, related scripts, this presentation  etc. can be found in this GitHub repo: [https://github.com/djolas/dataCapstoneCoursera](https://github.com/djolas/DataCapstoneCoursera)

* This pitch deck is located here: [http://rpubs.com/djolas/Prewordict](http://rpubs.com/nierhoff/cdsc)
